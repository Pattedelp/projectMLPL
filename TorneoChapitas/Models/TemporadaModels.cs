namespace TorneoAmigos.Models
{
    ...
    public class TemporadaCierre
    {
        ...
        public int? Ascenso3Id { get; set; }        // ganador promoción (si gana el de la B)
        public string? Ascenso3Nombre { get; set; }
        ...
        public string? AscensoCNombre1 { get; set; }
        public int? AscensoCId2 { get; set; }
        public string? AscensoCNombre2 { get; set; }
